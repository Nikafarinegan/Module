...
import ir.awlrhm.modules.utils.calendar.PersianCalendarConstants;
import ir.awlrhm.modules.utils.calendar.PersianCalendarUtils;
...
class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // inflate views
        View view = LayoutInflater.from(context).inflate(R.layout.awlrhm_persian_date_picker, this);
