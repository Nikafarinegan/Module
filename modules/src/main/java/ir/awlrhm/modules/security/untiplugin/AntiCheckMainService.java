...
//        System.exit(0);
        Intent intent = new Intent("checkPlugin"); //put the same message as in the filter you used in the activity when registering the receiver
        intent.putExtra("terminate_app", "Your App is plugin");
