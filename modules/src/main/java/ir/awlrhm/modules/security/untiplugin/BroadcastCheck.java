...
import ir.awlrhm.modules.security.untiplugin.Dummy.DummyReceiver;
...
public class BroadcastCheck {
    ...
    protected String receiver_name = "ir.nikafarinegan.automation.utils.security.untiplugin.Dummy.DummyReceiver";
